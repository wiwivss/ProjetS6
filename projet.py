...
def scrape_annonces(base_url, pages):
    ...
    for page in range(1, pages + 1):
        ...
        soup = getsoup(url)
        # Utiliser un sélecteur CSS plus spécifique pour récupérer les liens des annonces
...
# Exemple d'utilisation
url = "https://www.immo-entre-particuliers.com/annonce-cote-dor-chenove/409294-maison-recente-individuelle"
soup = getsoup(url)
